...
<div class="row">
    <!-- Contacts -->
    <?php if ($header): ?>
     <div class="col-md-6 bordered_block image_bck bordered_wht_border white_txt" data-image="<?php print base_path(); ?>sites/default/files/trav4.jpg">
	...
	<?php if ($rows): ?>
	<div class="col-md-6 bordered_block image_bck bordered_wht_border white_txt" data-image="<?php print base_path(); ?>sites/default/files/trav2.jpg">
	<div class="over" data-opacity="0.6" data-color="#292929"></div>
		<?php print $rows; ?>
	</div>
	<?php endif; ?>
