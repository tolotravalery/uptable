...
<div class="row">
    <!-- Contacts -->
    <?php if ($header): ?>
     <div class="col-md-6 bordered_block image_bck white_txt" data-image="<?php print base_path().path_to_theme(); ?>/images/sport8.jpg">
	...
	<?php if ($rows): ?>
	<div class="col-md-6 bordered_block image_bck white_txt" data-image="<?php print base_path().path_to_theme(); ?>/images/sport7.jpg">
		<?php print $rows; ?>
	</div>
	<?php endif; ?>
</div>