...
<div class="row">
    ...
    <?php if ($header): ?>
	<!--huhu-->
     <!--<div class="col-md-6 bordered_block image_bck grey_border" >-->
	 <div class="col-md-6 bordered_block image_bck bordered_wht_border white_txt" style="background-image: url(sites/all/themes/barg/images/contact-footer.jpg);">
		...
		<div class="col-md-12 simple_block text-left">
			...
			<span class="contacts_ti ti-location-pin"></span>999, jiangyue road,building 1, room 607,minhang district shanghai china<br />
