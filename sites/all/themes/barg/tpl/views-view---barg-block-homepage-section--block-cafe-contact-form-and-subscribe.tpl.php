...
<div class="row">
    <!-- Contacts -->
    <?php if ($header): ?>
     <div class="col-md-6 bordered_block image_bck white_txt" data-image="<?php print base_path().path_to_theme(); ?>/images/food6.jpg">
	...
	<?php if ($rows): ?>
	<div class="col-md-6 bordered_block image_bck white_txt" data-image="<?php print base_path().path_to_theme(); ?>/images/food8.jpg">
