...
<div class="row">
    <!-- Contacts -->
    <?php if ($header): ?>
     <div class="col-md-6 bordered_block image_bck white_txt" data-color="#4f547c">
	...
	<?php if ($rows): ?>
	<div class="col-md-6 bordered_block image_bck white_txt" data-image="<?php print base_path(); ?>sites/default/files/asia4.jpg">
