...
<div class="row">
    <!-- Contacts -->
    <?php if ($header): ?>
     <div class="col-md-6 bordered_block image_bck bordered_wht_border white_txt" data-image="<?php print base_path().path_to_theme(); ?>/images/hotel_c1.jpg">
		<div class="over" data-opacity="0.95" data-color="#000"></div>
